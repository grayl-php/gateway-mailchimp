 ...
 */
class MailChimpSubscribeRequestService implements
    RequestServiceInterface
{
    ...
    public function sendRequestDataEntity(
        ...
        $method = $this->replaceTags(
            "lists/{LIST_ID}/members/{SUBSCRIBER_HASH}",
            [
                'list_id'         => $request_data->getListID(),
                'subscriber_hash' => $this->makeSubscriberHash(
        ...
        // Get the parameters
        $parameters = $this->translateMailChimpSubscribeRequestData(
            $request_data
        );
    ...
    public function newResponseDataEntity(
        ...
        return new MailChimpSubscribeResponseData(
            $api_response,
            $gateway_name,
            $action
        );
     ...
     * @return array
     */
    private function translateMailChimpSubscribeRequestData(
        MailChimpSubscribeRequestData $request_data
    ): array {
