<?php
    ...
    */
   class MailChimpSubscribeResponseService implements ResponseServiceInterface
   {
      ...
      public function getReferenceID ( $response_data ): ?string
      {
         ...
         return $this->getResponseBodyField( $response_data,
                                             'id' );
      }
       ...
       * @return bool
       */
      private function isHTTPCodeSuccessful ( MailChimpSubscribeResponseData $response_data ): bool
      {

         // Get the HTTP status code from the response headers
         $code = $this->getResponseHeaderField( $response_data,
                                                'http_code' );
       ...
       * @return mixed
       */
      private function getResponseHeaderField ( MailChimpSubscribeResponseData $response_data,
                                                string $field ): ?string
      {
       ...
       * @return mixed
       */
      private function getResponseBodyField ( MailChimpSubscribeResponseData $response_data,
                                              string $field ): ?string
      {
         ...
         $data_decoded = json_decode( $data[ 'body' ],
                                      true );
