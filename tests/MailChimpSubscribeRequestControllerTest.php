 ...
 */
class MailChimpSubscribeRequestControllerTest extends
    TestCase
{
     ...
     * @throws \Exception
     */
    public function testCreateMailChimpSubscribeRequestController(
    ): MailChimpSubscribeRequestController
    {

        // Create the object
        $request = MailChimpPorter::getInstance()
            ->newMailChimpSubscribeRequestController(
                'newsletter',
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            MailChimpSubscribeRequestController::class,
            $request
        );
     ...
     * @throws \Exception
     */
    public function testSendMailChimpSubscribeRequestController(
        MailChimpSubscribeRequestController $request
    ): MailChimpSubscribeResponseController {
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            MailChimpSubscribeResponseController::class,
            $response
        );
     ...
     */
    public function testMailChimpSubscribeResponseController(
        MailChimpSubscribeResponseController $response
    ): void {
